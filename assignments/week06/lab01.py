...
def welcome_message(name, course):
    ...
    return "Welcome" + name + "to" + cousurse + "class"
...
def count_vowels_consonants(text):
    ...
    text = text.replace("","")
    text = text.lower()
    vowel = text.coun('a') + text.count('e') + text.count('i') + text.count('o') + text.count + text.count('u')
    numbers =text.coun('0') + text.count('1') + text.count('2') + text.count('3') + text.count + + text.count('4')text.coun('5') + text.count('6') + text.count('7') + text.count('8') + text.count + + text.count('9')
